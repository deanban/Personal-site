          ...
          <div class="fh5co-content-inner text-center">
            <div class="row row-bottom-padded-sm">
              <div class="col-md-12">
                ...
                <h1>Dean Banik</h1>
                <p>I am a recent
                  <a href="https://flatironschool.com"> Flatiron School Full Stack Development</a> graduate. Currently seeking exciting and challenging position as a software developer.</p>
              </div>
            </div>
            <div class="row">
            ...
            <ul class="fh5co-social">
              <li>
                <a href="mailto:dean.b87@icloud.com?Subject=Hello" target="_top">
              ...
              <li>
                <a href="https://github.com/deanban">
                  <i class="icon-github"></i>
                </a>
              </li>
              <li>
                <a href="https://linkedin.com/in/p-d-banik">
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="fh5co-feature">
                  ...
                  <div class="fh5co-text">
                    <h2>2011 - 2013</h2>
                    <p>Mechanical Engineeing at City College of New York</p>
            ...
            <div class="row">
              <div class="col-md-12">
                ...
                <div class="fh5co-feature">
                  ...
                  <div class="fh5co-text">
                    <h2>2015 - present</h2>
                    <h3>Domibus Real Estate Development</h3>
                    <p>Partner/Owner and developer</p>
                  </div>
                </div>
                ...
                <div class="fh5co-feature">
                  ...
                  <div class="fh5co-text">
                    <h2>2012 - 2014</h2>
                    <h3>Figmentum INC</h3>
                    <p>Owner/Partner and Film development technician</p>
                  </div>
                </div>
                ...
                <div class="fh5co-feature">
                  ...
                  <div class="fh5co-text">
                    <h2>2010 - 2013</h2>
                    <h3>Math, Physics, and Thermodynamics Tutor</h3>
                    <p></p>
                  </div>
                </div>
                ...
                <div class="fh5co-feature">
                  ...
                  <div class="fh5co-text">
                    <h2>2008 - 2010</h2>
                    <h3>Teller at JP Morgan Chase</h3>
                    {/* <p>Far far away, behind the word mountains, far from the countries.</p> */}
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="90">
                  <span>
                    <strong>Ruby</strong>90%</span>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="90">
                  <span>
                    <strong>Ruby on Rails</strong>90%</span>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="90">
                  <span>
                    <strong>JavaScript</strong>90%</span>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="80">
                  <span>
                    <strong>jQuery</strong>80%</span>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="95">
                  <span>
                    <strong>ReactJS</strong>95%</span>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="90">
                  <span>
                    <strong>Redux</strong>90%</span>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="90">
                  <span>
                    <strong>PostgreSQL</strong>90%</span>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="85">
                  <span>
                    <strong>HTML5</strong>85%</span>
                </div>
              </div>
              <div class="col-md-4 col-sm-6 col-xs-12 text-center">
                <div class="chart" data-percent="85">
                  <span>
                    <strong>CSS3</strong>85%</span>
                </div>
              </div>
